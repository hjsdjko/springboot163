...
public class WeixiushenqingEntity<T> implements Serializable {
	...
	private String guzhangxiangqing;
	 ...
	 * 设置：故障详情
	 */
	public void setGuzhangxiangqing(String guzhangxiangqing) {
		this.guzhangxiangqing = guzhangxiangqing;
	}
	/**
	 * 获取：故障详情
	 */
	public String getGuzhangxiangqing() {
		return guzhangxiangqing;
	}
	/**
	 * 设置：学号
	 */
